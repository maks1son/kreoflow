...
| 0:18–0:36 | Evidence table; zoom on source excerpt, then blocked claim | “It starts with product evidence. Claims keep their source. This invented battery-life claim is blocked before it can reach a scene.” |
...
| 1:58–2:16 | QA receipt: duration, fps, codec, claim coverage, hashes | “The receipt records what is proven: media format, timing, claim coverage, and exact hashes. It also says what remains a human judgment, such as taste and ad effectiveness.” |
| 2:16–2:31 | Approval receipt; edit one word and show stale state | “Human approval binds this exact spec to this exact render. Change either one and the approval becomes stale.” |
...
| 2:44–2:48 | Final ad end card | “KreoFlow: product evidence in, publishable craft out—with receipts.” |
